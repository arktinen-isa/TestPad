        ...
        {test.passThreshold && (
          <div className="flex items-center gap-2 p-3 rounded-xl bg-purple-accent/10 border border-purple-accent/20 mb-4">
            ...
            <p className="text-purple-300 text-sm">
              Прохідний бал: <span className="font-semibold text-white">{test.passThreshold}%</span>
            </p>
          </div>
        )}
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-slate-300 text-sm space-y-1">
              <li>• Тест проводиться у повноекранному режимі</li>
              <li>• Вихід з повноекранного режиму завершить тест</li>
              <li>• Переключення вкладок буде зафіксовано системою</li>
